...
- **Adam Ginesky**: 
    1. Evaluating expressions/functions with `eval()` and `parse()` 
...
## Speaker Gifts 
<div style="text-align:center"><img src = "images/Data_Points_Summit.png" width="600px"/></div>

- [Half Day Summit](https://datapoints.formulated.by/chicago/) (12:30-6:50 PM): covering data science for enterprise operations in Manufacturing, Retail and Finance.
- CRUG received three free passes
- For volunteered speakers: Svetlana, Dylan, and Open Mic (w/ tie breaker)
